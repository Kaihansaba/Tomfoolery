...
const nodes = new Map([
  ['n1', { id: 'n1', position: { x: 0, y: 0 }, type: 'waypoint', incomingEdges: [], outgoingEdges: [] }],
  ['n2', { id: 'n2', position: { x: 1, y: 0 }, type: 'waypoint', incomingEdges: [], outgoingEdges: [] }],
  ['n3', { id: 'n3', position: { x: 2, y: 0 }, type: 'waypoint', incomingEdges: [], outgoingEdges: [] }],
]);

const edges = new Map([
  ['e1', { id: 'e1', fromNode: 'n1', toNode: 'n2', lanes: [], laneCount: 1, geometry: [], roadType: 'local', oneWay: true }],
  ['e2', { id: 'e2', fromNode: 'n2', toNode: 'n3', lanes: [], laneCount: 1, geometry: [], roadType: 'local', oneWay: true }],
]);
